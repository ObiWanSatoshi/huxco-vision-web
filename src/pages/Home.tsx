      ...
      <section className="relative minimal-gradient">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-light leading-tight mb-6 tracking-tight animate-text-reveal">
              Accelerating the Advent of
              <span className="block text-white/90 font-normal glitch-text" data-text="Humanity's Golden Era">
                Humanity's Golden Era
              </span>
            </h1>
            <p className="text-xl md:text-2xl text-white/70 mb-8 leading-relaxed font-light animate-text-reveal" style={{ animationDelay: '0.2s' }}>A venture firm backing the builders of civilization-scale technologies.</p>
            <p className="text-lg text-white/60 mb-12 leading-relaxed font-light max-w-3xl animate-text-reveal" style={{ animationDelay: '0.4s' }}>We stand at the threshold of a new era where immutable systems, intelligent infrastructure, and atomic breakthroughs converge to redefine the substrate of reality.</p>
            <div className="flex flex-col sm:flex-row gap-4 animate-text-reveal" style={{ animationDelay: '0.6s' }}>
              <NavLink to="/thesis" className="inline-flex items-center px-8 py-4 bg-white/10 text-white font-medium rounded hover:bg-white/15 transition-all duration-200 border border-white/20 interactive-zone">
                Our Thesis
                <ArrowRight className="ml-2 h-4 w-4" />
              </NavLink>
              <NavLink to="/contact" className="inline-flex items-center px-8 py-4 border border-white/30 text-white font-medium rounded hover:bg-white/5 hover:border-white/40 transition-all duration-200 interactive-zone">Share Your Future</NavLink>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-card/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card/50 backdrop-blur-sm p-8 rounded border border-white/10 hover:bg-card/70 transition-all duration-300 interactive-zone morph-bg">
...
Civilization-scale technologies solving problems in atoms, not bits.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-white/20 transition-all duration-300 animate-pulse-slow">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-white/20 transition-all duration-300 animate-pulse-slow" style={{ animationDelay: '1s' }}>
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-white/20 transition-all duration-300 animate-pulse-slow" style={{ animationDelay: '2s' }}>
                <span className="text-xl font-light text-white/90">∞</span>
              </div>
      ...
      <section className="py-20 bg-card/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <NavLink to="/contact" className="inline-flex items-center px-8 py-4 bg-white/10 text-white font-medium rounded hover:bg-white/15 transition-all duration-200 border border-white/20 interactive-zone">
