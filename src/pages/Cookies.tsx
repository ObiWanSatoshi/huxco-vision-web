      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Analytics and Performance Cookies</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Functionality Cookies</h3>
              <p className="text-gray-600 mb-4">
